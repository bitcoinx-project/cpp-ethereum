...
public:
	...
	void setBCXSchedule(EVMSchedule _schedule) const { m_BCXSchedule = _schedule; }

	EVMSchedule& getBCXSchedule() const { return m_BCXSchedule; }

	mutable std::set<Address> mDeletionAddresses;
...
private:
	...
	mutable EVMSchedule m_BCXSchedule;
