...
#include "genesis/bcxMainNetwork.cpp"
#include "genesis/bcxTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::BCXMainNetwork: return c_genesisInfoBCXMainNetwork;
	case Network::BCXTestNetwork: return c_genesisInfoBCXTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::BCXMainNetwork: return c_genesisStateRootBCXMainNetwork;
	case Network::BCXTestNetwork: return c_genesisStateRootBCXTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
